...
# nacteni obrazku
obrazek = pygame.image.load('troll-coloring-page_1.png')
obrazek = pygame.transform.scale(obrazek, (velikost, velikost))

# vytvoreni okna
okno = pygame.display.set_mode((ROZLISENI_X, ROZLISENI_Y))
pygame.display.set_caption('Hra na schovávanou')
...
while True:
    ...
    for x in range(0, ROZLISENI_X, velikost):
        for y in range(0, ROZLISENI_Y, velikost):
            okno.blit(obrazek, (x, y))
